            ...
            <div className="hidden md:block">
              <nav aria-label="Global">
                <ul className="flex items-center gap-6 text-sm">
                  <li>
                    <a
                      className={`transition focus:bg-gray-200 active:bg-blue-800 rounded-md px-2 py-1 ${
                        currentPath === "/" ? "border-b-2 border-blue-800" : ""
                      } hover:text-blue-800`}
                      href="/"
                    >
                      About
                  ...
                  <li>
                    <a
                      className={`transition focus:bg-gray-200 active:bg-blue-800 rounded-md px-2 py-1 ${
                        currentPath.includes("/general/vehicles")
            ...
            <div className="flex items-center gap-4">
              {accessToken !== null ? (
                ...
                >
                  <Image
                    alt="Profile"
                    src={profilImgSrc || "/default-profile.png"}
          ...
          <div className="md:hidden bg-white shadow-lg">
            <nav aria-label="Global" className="p-4">
              <ul className="space-y-4 text-sm">
                <li>
                  <a
                    className="block text-black hover:text-blue-800 transition focus:bg-gray-200 active:bg-blue-800 rounded-md px-2 py-1"
                    href="/"
                  >
                    About
                  </a>
